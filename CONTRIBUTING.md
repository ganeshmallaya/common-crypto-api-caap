...
Unsolicited pull requests and code contributions are not accepted until the
maintainer publishes explicit contribution and intellectual-property terms.
Opening an issue or sending feedback does not transfer copyright and does not
